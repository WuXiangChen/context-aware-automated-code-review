...
class DatabaseConfig:
    ...
    def from_local_env(cls):
        return cls(
            connection_string=os.getenv('MONGODB_CONNECTION_STRING', 'mongodb://wxc:wxc@172.27.149.102:27017/?authSource=admin&readPreference=primary&directConnection=true&ssl=false'),
            database_name=os.getenv('MONGODB_DATABASE_NAME', 'prim_acr'))
